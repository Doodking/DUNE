@section('shopViewNav')
    <div class="shops pt-4 my-md-5 pt-md-5 border-bottom">
        <div style="text-align: center">
            <h2>SHOPS OF {{strtoupper(Auth::user()->name)}}</h2>
            <div class="card my-3" id="logo">
                ...
                <div class="card-body" style="text-align: center">
                    <h5 class="card-title">Total shops per user {{count($shops)}}</h5>
                    <p class="card-text"> </p>
                    <p class="card-text"><small class="text-muted">@У вас неплохая статистика продавца</small></p>
                </div>
            </div>
        </div>
