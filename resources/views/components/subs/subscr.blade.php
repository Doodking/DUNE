                    ...
                    <div class="mt-3">
                        @foreach($user as $u)
                            <div class="alert alert-light alert-dismissible fade show" role="alert">
                                ...
                                <a href="/account/chat"><i class="fa fa-comments-o" aria-hidden="true"></i></a>
                                <a style="margin-right: 30px" href="{{'/account/user/' . $u->id}}"><button type="button" class="close" aria-label="Close">
